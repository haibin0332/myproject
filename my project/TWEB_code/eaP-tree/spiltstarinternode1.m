function [internode2_1, internode2_2]=spiltstarinternode1(internode1)
    ...
    i=size(internode1.internode1, 2);
    
for v=1:1:i
     tempinternode(v)=internode1.internode1(v);    
end
...
for p=1:1:ceil(i/2)
    internode2_1.internode1(p)=tempinternode(p);  
...
internode2_1.pricerange.min_price=internode2_1.internode1(1).pricerange.min_price;
internode2_1.pricerange.max_price=internode2_1.internode1(1).pricerange.max_price;

for u=1:1:size(internode2_1.internode1,2)
    if internode2_1.pricerange.min_price>internode2_1.internode1(u).pricerange.min_price
         internode2_1.pricerange.min_price=internode2_1.internode1(u).pricerange.min_price;
    end
    if internode2_1.pricerange.max_price<internode2_1.internode1(u).pricerange.max_price
         internode2_1.pricerange.max_price=internode2_1.internode1(u).pricerange.max_price;
    end
...
for p=(ceil(i/2)+1):1:i
    internode2_2.internode1(p-ceil(i/2))=tempinternode(p);  
