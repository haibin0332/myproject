function  [node3, mark]=splitnode2(node2, num1, num2, rating1, rating2, rating3, rating4, rating5, item) %num2时间， num1 钱
%%%%%%%%%%%%%%%%%
%%%%%%%%此部分被kdbtree调用
%%%%%%%%%%%
n_leaf=51;
...
node_1(1).onedimR=node1(node1_num).onedimR;
 for j=1:1:(w(1)-1)    
...
[node_1(2).sum_num, node_1(2).sum_rating(1), node_1(2).sum_rating(2), node_1(2).sum_rating(3), node_1(2).sum_rating(4), node_1(2).sum_rating(5), node_1(2).onedimR]=smallsizemerge(tempnode);
...
for p=1:1:size(z,2)
    ...
    ttempnode(k11).onedimR=node1(z(p)).onedimR;
    k11=k11+1;
end

[node2(2).sum_num, node2(2).sum_rating(1), node2(2).sum_rating(2), node2(2).sum_rating(3), node2(2).sum_rating(4), node2(2).sum_rating(5), node2(2).onedimR]=smallsizemerge(ttempnode);
...
node_1(2).level=1;
node_1(2).dimark=1;
node_1(2).mintime=node1(node1_num).node(pot).mintime;
node_1(2).maxtime=max;%%新结点时间
node_1(2).minprice=0;
node_1(2).maxprice=max;
...
[node_1(2).sum_num, node_1(2).sum_rating(1), node_1(2).sum_rating(2), node_1(2).sum_rating(3), node_1(2).sum_rating(4), node_1(2).sum_rating(5), node_1(2).onedimR]=smallsizemerge(vtempnode);
...
node_1(2).onedimR=rtemp.onedimR;
