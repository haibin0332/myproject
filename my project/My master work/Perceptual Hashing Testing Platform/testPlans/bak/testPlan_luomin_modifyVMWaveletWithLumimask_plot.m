workdir_Macro = 'E:\DoctorThesis\MBench\Plan\outdir\luomin_modifyVMWaveletWithLumimask\power0_008_with_contrastThreshold'
matchfun = @match_luomin_modifyVMWaveletWithLumimask_Euclidean  ;  %match_luomin_modifyVMWaveletWithLumimask_CountIntersection
extractfunname = 'luomin_modifyVMWaveletWithLumimask';
%{
实验笔记：
1、match_luomin_modifyVMWaveletWithLumimask_Euclidean 
2、将目录里面的power0.01改为power0_01，不然会出错
3、extractBy-mbe_zh_descendingDimensionOfWatson.mat 中删掉第1 3 9 30 35 张图片的信息，
4、得到normalize的范围为： [0,0.18] - [0,0.5]
