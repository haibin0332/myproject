workdir_Macro = 'E:\DoctorThesis\MBench\Plan\outdir\Fridrich_HVSWeighted\method_1_256_randomBlocking'% 'E:\DoctorThesis\MBench\Plan\outdir\mbe_WangShuoZhong_watsonBased\Original' %
matchfun = '';  % @match_luomin_modifyVMWaveletWithLumimask_Euclidean
extractfunname = 'Fridrich_bitsextraction_HVSWeighted' % 'WangShuoZhong_watsonBased_corrected';% 'WangShuoZhong_watsonBased' %
%{
实验笔记：
%}
%
...
hist(interDistances, nbins)
f4 = figure;
ksdensity(interDistances, 'npoints', nbins, 'support', 'positive', 'kernel', 'box');
[f, xi, u] = ksdensity(interDistances, 'npoints', nbins, 'support', 'positive', 'kernel', 'box');
%}
%%
% 记录获得分布中心的实验过程：
%% 
