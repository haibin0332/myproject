workdir_Macro = 'E:\DoctorThesis\MBench\Plan\outdir\mbe_Wyn2_watsonBased\Method3\withoutP2_mean'% 'E:\DoctorThesis\MBench\Plan\outdir\mbe_WangShuoZhong_watsonBased\Original' %
matchfun = '';  % @match_luomin_modifyVMWaveletWithLumimask_Euclidean
extractfunname = 'wang_AuthenticationPHBasedWaston' % 'WangShuoZhong_watsonBased_corrected';% 'WangShuoZhong_watsonBased' %
%{
实验笔记：
%}
%
