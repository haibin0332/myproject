...
extractPlan(1).imdir = 'E:\DoctorThesis\MBench\Plan\outdir\imAttacked';
extractPlan(1).testImages = 'testImages';
extractPlan(1).outdir = 'E:\DoctorThesis\MBench\Plan\outdir\mbe_Wyn2_watsonBased\Method3\withoutP2_mean';
extractPlan(1).customedOutName = '';
extractPlan(1).algfun = @mbe_wang_AuthenticationPHBasedWaston;
% extractPlan(1).params = [3 1:7:300 256];
